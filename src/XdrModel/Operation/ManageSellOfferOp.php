 ...
 */
class ManageSellOfferOp extends Operation
{
    /**
     * @var Asset
     */
    ...
    {
        parent::__construct(Operation::TYPE_MANAGE_SELL_OFFER, $sourceAccount);
    ...
    public static function fromXdr(XdrBuffer $xdr)
    {
        ...
        return new ManageSellOfferOp($sellingAsset,
            $buyingAsset,
